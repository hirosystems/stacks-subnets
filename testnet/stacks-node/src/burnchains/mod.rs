...
use stacks::burnchains::{self, BurnBlockInputChannel};
...
/// Holds the L1Controller, which might be able to be deleted.
pub mod l1_events;

/// Database-backed `BurnchainIndexer`.
pub mod db_indexer;
mod tests;
...
pub trait BurnchainController {
    ...
    /// Returns a channel that can be used to push blocks to the underlying indexer.
